...
\makeatother
\fancyfoot[R]{\rm\hfill samples{\tt /}hanoi.rb\qquad page \thepage}
\begin{document}
...
\noindent
\mbox{}\rm\mc {\tt\#}\  {}\centerline{\bf Towers of Hanoi (Ruby)}  \rm\mc 
...
\noindent
\mbox{}\rm\mc {\tt\#}\  \hrulefill\ hanoi.rb \ \hrulefill \rm\mc 
...
\noindent
\mbox{}\tt\mc {\tt\mc \ \ \ \ }ARRAY.times{\tt\mc \ }do{\tt\mc \ }{\tt |}j{\tt |}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\$}disc[0][j]{\tt\mc \ }={\tt\mc \ }ARRAY{\tt\mc \ }{\tt -}{\tt\mc \ }j

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\$}disc[1][j]{\tt\mc \ }={\tt\mc \ }0

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\$}disc[2][j]{\tt\mc \ }={\tt\mc \ }0
...
\noindent
\mbox{}{\tt\$}counter{\tt\mc \ }={\tt\mc \ }0{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\rm\mc {\tt\#}\  {}移動回数カウンタ \hfill  \rm\mc 
...
\noindent
\mbox{}\tt\mc {\tt\mc \ \ \ \ }{\tt\$}counter{\tt\mc \ }+={\tt\mc \ }1

\noindent
\mbox{}{\tt\mc \ \ \ \ }puts{\tt\mc \ }{\tt "}{\tt -}{\tt -}{\tt -}{\tt\#}{\tt\#}{\tt\char'173}{\tt\$}counter{\tt\char'175}{\tt -}{\tt -}{\tt -}{\tt "}

\noindent
\mbox{}{\tt\mc \ \ \ \ }3.times{\tt\mc \ }do{\tt\mc \ }{\tt |}i{\tt |}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }print{\tt\mc \ }{\tt "}[{\tt\#}{\tt\char'173}i{\tt\char'175}]{\tt\mc \ }{\tt "}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }ARRAY.times{\tt\mc \ }do{\tt\mc \ }{\tt |}j{\tt |}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ }if{\tt\mc \ }{\tt\$}disc[i][j]{\tt\mc \ }!={\tt\mc \ }0

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }print{\tt\mc \ }{\tt "}{\tt\#}{\tt\char'173}{\tt\$}disc[i][j]{\tt\char'175}{\tt\mc \ }{\tt "}
...
\noindent
\mbox{}{\tt\$}ptr{\tt\mc \ }={\tt\mc \ }[0,{\tt\mc \ }0,{\tt\mc \ }0]{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\rm\mc {\tt\#}\  {}disc 移動用ポインタ \hfill  \rm\mc 
...
\noindent
\mbox{}\tt\mc {\tt\mc \ \ \ \ }{\tt\$}ptr[i]{\tt\mc \ }{\tt -}={\tt\mc \ }1

\noindent
\mbox{}{\tt\mc \ \ \ \ }{\tt\$}disc[j][{\tt\$}ptr[j]]{\tt\mc \ }={\tt\mc \ }{\tt\$}disc[i][{\tt\$}ptr[i]]

\noindent
\mbox{}{\tt\mc \ \ \ \ }{\tt\$}ptr[j]{\tt\mc \ }+={\tt\mc \ }1

\noindent
\mbox{}{\tt\mc \ \ \ \ }{\tt\$}disc[i][{\tt\$}ptr[i]]{\tt\mc \ }={\tt\mc \ }0
...
\noindent
\mbox{}move{\tt\_}discs(ARRAY,{\tt\mc \ }0,{\tt\mc \ }1,{\tt\mc \ }2){\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\rm\mc {\tt\#}\  {}{\tt ARRAY} 枚の disc を \hfill  \rm\mc 
