...
\makeatother
\fancyfoot[R]{\rm\hfill samples{\tt /}hanoi.kt\qquad page \thepage}
\begin{document}
...
\noindent
\mbox{}\rm\mc {\tt /}{\tt *}\  \hrulefill\ hanoi.kt \ \hrulefill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}const{\tt\mc \ }val{\tt\mc \ }ARRAY{\tt\mc \ }={\tt\mc \ }8{\tt\mc \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}disc の数 \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}val{\tt\mc \ }disc{\tt\mc \ }={\tt\mc \ }Array(3){\tt\mc \ }{\tt\char'173}{\tt\mc \ }IntArray(ARRAY){\tt\mc \ }{\tt\char'175}{\tt\mc \ }\rm\mc {\tt /}{\tt *}\  {}disc に関するデータの置き場所
					   \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}fun{\tt\mc \ }initArray(){\tt\mc \ }{\tt\char'173}{\tt\mc \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}disc に関するデータの初期化
					   \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 

\noindent
\mbox{}{\tt\mc \ \ \ \ }for{\tt\mc \ }(j{\tt\mc \ }in{\tt\mc \ }0{\tt\mc \ }until{\tt\mc \ }ARRAY){\tt\mc \ }{\tt\char'173}
...
\noindent
\mbox{}fun{\tt\mc \ }printResult(){\tt\mc \ }{\tt\char'173}{\tt\mc \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}結果の表示 \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}{\tt\mc \ \ \ \ }println({\tt "}{\tt -}{\tt -}{\tt -}{\tt\#}{\tt\$}counter{\tt -}{\tt -}{\tt -}{\tt "})

\noindent
\mbox{}{\tt\mc \ \ \ \ }for{\tt\mc \ }(i{\tt\mc \ }in{\tt\mc \ }0..2){\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }print({\tt "}[{\tt\$}i]{\tt\mc \ }{\tt "})
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }print({\tt "}{\tt\$}{\tt\char'173}disc[i][j]{\tt\char'175}{\tt\mc \ }{\tt "})
...
\noindent
\mbox{}val{\tt\mc \ }ptr{\tt\mc \ }={\tt\mc \ }intArrayOf(0,{\tt\mc \ }0,{\tt\mc \ }0){\tt\mc \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}disc 移動用ポインタ（インデックス）
					   \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}fun{\tt\mc \ }moveOneDisc(i:{\tt\mc \ }Int,{\tt\mc \ }j:{\tt\mc \ }Int){\tt\mc \ }{\tt\char'173}{\tt\mc \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}1枚の disc を pole $i$ から
...
\noindent
\mbox{}fun{\tt\mc \ }moveDiscs(n:{\tt\mc \ }Int,{\tt\mc \ }i:{\tt\mc \ }Int,{\tt\mc \ }j:{\tt\mc \ }Int,{\tt\mc \ }k:{\tt\mc \ }Int){\tt\mc \ }{\tt\char'173}
...
\noindent
\mbox{}fun{\tt\mc \ }main(){\tt\mc \ }{\tt\char'173}
...
\noindent
\mbox{}{\tt\mc \ \ \ \ }moveDiscs(ARRAY,{\tt\mc \ }0,{\tt\mc \ }1,{\tt\mc \ }2){\tt\mc \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}{\tt ARRAY} 枚の disc を
