...
\makeatother
\fancyfoot[R]{\rm\hfill samples{\tt /}hanoi.go\qquad page \thepage}
\begin{document}
...
\noindent
\mbox{}\rm\mc {\tt /}{\tt *}\  \hrulefill\ hanoi.go \ \hrulefill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}package{\tt\mc \ }main

\noindent
\mbox{}\hfill

\noindent
\mbox{}import{\tt\mc \ }{\tt "}fmt{\tt "}

\noindent
\mbox{}\hfill

\noindent
\mbox{}const{\tt\mc \ }ARRAY{\tt\mc \ }={\tt\mc \ }8{\tt\mc \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}disc の数 \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}var{\tt\mc \ }disc{\tt\mc \ }[3][ARRAY]int{\tt\mc \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}disc に関するデータの置き場所
					   \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }for{\tt\mc \ }j{\tt\mc \ }:={\tt\mc \ }0;{\tt\mc \ }j{\tt\mc \ }{\tt <}{\tt\mc \ }ARRAY;{\tt\mc \ }j++{\tt\mc \ }{\tt\char'173}
...
\noindent
\mbox{}var{\tt\mc \ }counter{\tt\mc \ }int{\tt\mc \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}移動回数カウンタ \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }fmt.Printf({\tt "}{\tt -}{\tt -}{\tt -}{\tt\#}{\tt\%}d{\tt -}{\tt -}{\tt -}{\tt\char92}n{\tt "},{\tt\mc \ }counter)

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }for{\tt\mc \ }i{\tt\mc \ }:={\tt\mc \ }0;{\tt\mc \ }i{\tt\mc \ }{\tt <}={\tt\mc \ }2;{\tt\mc \ }i++{\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }fmt.Printf({\tt "}[{\tt\%}d]{\tt\mc \ }{\tt "},{\tt\mc \ }i)

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }for{\tt\mc \ }j{\tt\mc \ }:={\tt\mc \ }0;{\tt\mc \ }j{\tt\mc \ }{\tt <}{\tt\mc \ }ARRAY;{\tt\mc \ }j++{\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }if{\tt\mc \ }disc[i][j]{\tt\mc \ }!={\tt\mc \ }0{\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }fmt.Printf({\tt "}{\tt\%}d{\tt\mc \ }{\tt "},{\tt\mc \ }disc[i][j])

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\char'175}{\tt\mc \ }else{\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }break

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\char'175}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\char'175}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }fmt.Println()
...
\noindent
\mbox{}var{\tt\mc \ }ptr{\tt\mc \ }[3]int{\tt\mc \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}disc 移動用ポインタ（インデックス）
					   \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 
...
\noindent
\mbox{}func{\tt\mc \ }moveOneDisc(i,{\tt\mc \ }j{\tt\mc \ }int){\tt\mc \ }{\tt\char'173}{\tt\mc \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}1枚の disc を pole $i$ から
...
\noindent
\mbox{}func{\tt\mc \ }moveDiscs(n,{\tt\mc \ }i,{\tt\mc \ }j,{\tt\mc \ }k{\tt\mc \ }int){\tt\mc \ }{\tt\char'173}{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}上から $n$ 枚目までの disc
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }moveDiscs(n{\tt -}1,{\tt\mc \ }i,{\tt\mc \ }k,{\tt\mc \ }j){\tt\mc \ }\rm\mc {\tt /}{\tt *}\  {}関数 {\tt moveDiscs()}
					   の中で、さらに自分自身 \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }moveOneDisc(i,{\tt\mc \ }j){\tt\mc \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}{\tt moveDiscs()} が使われ
					   ている。このような \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }printResult(){\tt\mc \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}手法は、「再帰的呼びだし」
					   といわれる。 \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }moveDiscs(n{\tt -}1,{\tt\mc \ }k,{\tt\mc \ }j,{\tt\mc \ }i)
...
\noindent
\mbox{}func{\tt\mc \ }main(){\tt\mc \ }{\tt\char'173}
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }moveDiscs(ARRAY,{\tt\mc \ }0,{\tt\mc \ }1,{\tt\mc \ }2){\tt\mc \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}{\tt ARRAY} 枚の disc を
