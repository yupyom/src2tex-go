...
\makeatother
\fancyfoot[R]{\rm\hfill samples{\tt /}hanoi.rs\qquad page \thepage}
\begin{document}
...
\noindent
\mbox{}{\tt\mc \ \ \ \ }unsafe{\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }for{\tt\mc \ }j{\tt\mc \ }in{\tt\mc \ }0..ARRAY{\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ }DISC[0][j]{\tt\mc \ }={\tt\mc \ }(ARRAY{\tt\mc \ }{\tt -}{\tt\mc \ }j){\tt\mc \ }as{\tt\mc \ }i32;
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }println!({\tt "}{\tt -}{\tt -}{\tt -}{\tt\#}{\tt\char'173}{\tt\char'175}{\tt -}{\tt -}{\tt -}{\tt "},{\tt\mc \ }COUNTER);

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }for{\tt\mc \ }i{\tt\mc \ }in{\tt\mc \ }0..3{\tt\mc \ }{\tt\char'173}

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ }print!({\tt "}[{\tt\char'173}{\tt\char'175}]{\tt\mc \ }{\tt "},{\tt\mc \ }i);
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }print!({\tt "}{\tt\char'173}{\tt\char'175}{\tt\mc \ }{\tt "},{\tt\mc \ }DISC[i][j]);
...
\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }move{\tt\_}discs(n{\tt\mc \ }{\tt -}{\tt\mc \ }1,{\tt\mc \ }i,{\tt\mc \ }k,{\tt\mc \ }j);{\tt\mc \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}関数 {\tt move\_discs()}
					   の中で、さらに自分自身 \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }move{\tt\_}one{\tt\_}disc(i,{\tt\mc \ }j);{\tt\mc \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}{\tt move\_discs()} が使われ
					   ている。このような \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }print{\tt\_}result();{\tt\mc \ }{\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  {}手法は、「再帰的呼びだし」
					   といわれる。 \hfill \rm\mc \ {\tt *}{\tt /}
\tt\mc 

\noindent
\mbox{}{\tt\mc \ \ \ \ \ \ \ \ }move{\tt\_}discs(n{\tt\mc \ }{\tt -}{\tt\mc \ }1,{\tt\mc \ }k,{\tt\mc \ }j,{\tt\mc \ }i);
...
\noindent
\mbox{}{\tt\mc \ \ \ \ }move{\tt\_}discs(ARRAY{\tt\mc \ }as{\tt\mc \ }i32,{\tt\mc \ }0,{\tt\mc \ }1,{\tt\mc \ }2);{\tt\mc \ \ }\rm\mc {\tt /}{\tt *}\  {}{\tt ARRAY} 枚の disc を
