...
var disc [3][ARRAY]int			/* {\ disc に関するデータの置き場所
					   \hfill} */
...
var ptr [3]int				/* {\ disc 移動用ポインタ（インデックス）
					   \hfill} */

func moveOneDisc(i, j int) {		/* {\ 1枚の disc を pole $i$ から
					   pole $j$ に移動する \hfill} */
	ptr[i]--
...
func moveDiscs(n, i, j, k int) {	/* {\ 上から $n$ 枚目までの disc
